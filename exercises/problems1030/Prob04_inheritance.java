package java1029_inheritance.prob;
...
class HealthRate extends Health {
	...
	overweightRate = (weight-standardHealth())/standardHealth()*100;
		if (overweightRate<10)
			return "정상";
		else if(overweightRate>=10 && overweightRate<20) 
			return "과체중";
		else
			return "비만";
	}
